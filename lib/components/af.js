    ...
    switch (type) {
        ...
        case 'zclIncomingMsg':
            ...
            const cmdIDs = [
                ...
                'cmd0x0000', 'cmd0x0001', 'cmd0x0002','cmd0x0003','cmd0x0004','cmd0x0005',
                'cmd0x0006', 'cmd0x0007', 'cmd0x0008', 'cmd0x0009', 'cmd0x0010',
                'cmd0x8000', 'cmd0x8001', 'cmd0x8002','cmd0x8003','cmd0x8004','cmd0x8005',
                'cmd0x8006', 'cmd0x8007', 'cmd0x8008', 'cmd0x8009', 'cmd0x8010',
            ];
...
module.exports = function (controller) {
    ...
    af.areq = new Areq(controller, 3333);
